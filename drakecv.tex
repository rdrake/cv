...
\begin{document}
	...
	\section{Summary of Qualifications}
		\cvitem{}{\listitemsymbol Experience administrating OS X Server, dozens of OS X and Windows client machines, Linux servers, and FreeBSD servers}
	...
	\section{Master Thesis}
		...
		\cvitem{Description}{In this thesis we investigated the feasibility of transforming data in a relational form into a document form.  This would allow users without domain knowledge or knowledge of SQL to find information quickly and efficiently.}
